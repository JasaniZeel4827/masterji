...
function LoginForm() {
    ...
    const [emailPending, startEmailTransition] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransition"])();
    ...
    function signInWithEmail() {
        startEmailTransition(async ()=>{
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["authClient"].emailOtp.sendVerificationOtp({
                email: email,
                type: 'sign-in',
                fetchOptions: {
                    onSuccess: ()=>{
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('email sent successfully');
                        router.push("/verify-request?email=".concat(email));
                    },
                    onError: ()=>{
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error('failed to send email');
                    }
                }
            });
        });
...
_s(LoginForm, "iIBWgt/Gl5/Hwawdwbtawjt8yss=", false, function() {
    return [
...
//# sourceMappingURL=_abd509ec._.js.map