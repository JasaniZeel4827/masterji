 ...
 */ const config = {
    ...
    "inlineSchemaHash": "d5a0698f4fc9661395d260aea53827ed46986114db58205dafca76416a210d71",
    "copyEngine": true
};
...
async function protect(req) {
    ...
    if (session?.user.id) {
        ...
        userId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$arcjet$2f$ip$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(req) || "127.0.0.1"; // Fall back to local IP if none
    }
    // If this is a signup then use the special protectSignup rule
    // See https://docs.arcjet.com/signup-protection/quick-start
    if (req.nextUrl.pathname.startsWith("/api/auth/sign-up")) {
        ...
        // https://www.better-auth.com/docs/concepts/hooks#example-enforce-email-domain-restriction
        if (typeof body.email === "string") {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$arcjet$2f$next$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].withRule((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$arcjet$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["protectSignup"])(signupOptions)).protect(req, {
                email: body.email,
                fingerprint: userId
            });
        } else {
            // Otherwise use rate limit and detect bot
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$arcjet$2f$next$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].withRule((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$arcjet$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["detectBot"])(botOptions)).withRule((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$arcjet$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["slidingWindow"])(rateLimitOptions)).protect(req, {
                fingerprint: userId
            });
        }
    } else {
        // For all other auth requests
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$arcjet$2f$next$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].withRule((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$arcjet$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["detectBot"])(botOptions)).protect(req, {
            fingerprint: userId
        });
    }
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__04ebd15d._.js.map